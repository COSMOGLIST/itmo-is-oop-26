...
public abstract class AbstractFileDeleteArgumentHandler : IFileDeleteArgumentHandler
{
    private IFileDeleteArgumentHandler? _nextHandler;

    public IFileDeleteArgumentHandler SetNext(IFileDeleteArgumentHandler handler)
    {
    ...
    public virtual ArgumentHandlerResult Handle(IEnumerator<string> commandText, FileDeleteArguments.Builder builder)
    {
