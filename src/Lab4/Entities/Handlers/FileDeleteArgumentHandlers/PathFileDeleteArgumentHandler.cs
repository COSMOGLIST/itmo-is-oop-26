...
public class PathFileDeleteArgumentHandler : AbstractFileDeleteArgumentHandler
{
    public override ArgumentHandlerResult Handle(IEnumerator<string> commandText, FileDeleteArguments.Builder builder)
    {
