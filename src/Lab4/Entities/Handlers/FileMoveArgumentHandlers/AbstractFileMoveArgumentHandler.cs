...
public abstract class AbstractFileMoveArgumentHandler : IFileMoveArgumentHandler
{
    private IFileMoveArgumentHandler? _nextHandler;

    public IFileMoveArgumentHandler SetNext(IFileMoveArgumentHandler handler)
    {
    ...
    public virtual ArgumentHandlerResult Handle(IEnumerator<string> commandText, FileMoveArguments.Builder builder)
    {
