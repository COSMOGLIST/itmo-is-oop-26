...
public abstract class AbstractFileRenameArgumentHandler : IFileRenameArgumentHandler
{
    private IFileRenameArgumentHandler? _nextHandler;

    public IFileRenameArgumentHandler SetNext(IFileRenameArgumentHandler handler)
    {
    ...
    public virtual ArgumentHandlerResult Handle(IEnumerator<string> commandText, FileRenameArguments.Builder builder)
    {
